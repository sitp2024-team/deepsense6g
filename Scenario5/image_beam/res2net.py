...
__all__ = ['Res2Net', 'res2net50','res2net50_26w_4s']
...
def res2net50_26w_4s(pretrained=True, **kwargs):
    ...
    model = Res2Net(Bottle2neck, [3, 4, 6, 3], baseWidth=26, scale=4, **kwargs)
    if pretrained:
        state_dict = model_zoo.load_url(model_urls['res2net50_26w_4s'])
...
if __name__ == '__main__':
    ...
    model = res2net50_26w_4s(pretrained=True, num_classes=33)
    model = model.cuda(0)
